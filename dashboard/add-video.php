                            ...
                            <div class="page-header">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Video</a></li>
							...
							<div class="card-body">
								<form method="post" action="input.php" enctype="multipart/form-data">
									<div class="form-group">
										<label for="Judul" class="col-form-label">Judul Video</label>
									...
									<div class="custom-file mb-3">
										<label class="custom-file-label" for="fileaudio">File Video</label>
										<input type="file" class="custom-file-input" id="file" name="file" accept="video/mp4" required="">
									</div>
									<div class="form-group">
